...
| 深度思考开 / 关 | 83.2s / 1.9s | 同一个 parsing 请求, 两组对照; 开着直接爆掉 60 秒调用上限 |
...
2. **`C1` 不设注入 0% 门槛** (SPEC-007 补入 37)。降档带来的安全退化是这一组
